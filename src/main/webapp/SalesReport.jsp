...
<body>
	...
	<div class="d-flex justify-content-start mb-3">
		        ...
		        <a type="submit" href="AdminHome.jsp" class="btn btn-primary">Home</a>
		    </div>
		    </div>
<div class="container mt-4">
							...
							<%
								...
								ResultSet rs = stmt.executeQuery("SELECT Sale.price, Item.name, Item.subcategory, Sale.seller_id, Sale.buyer_id FROM Sale JOIN Item ON Sale.Sale_itemid = Item.itemId");
						  ...
						  <table class="table table-striped">
							...
							<%
								...
								ResultSet rs1 = stmt1.executeQuery("SELECT Item.subcategory, sum(Sale.price) as b FROM Sale JOIN Item ON Sale.Sale_itemid = Item.itemid GROUP BY subcategory");
								while (rs1.next()) {
						   ...
						   <table class="table table-striped">
							...
							<%
								...
								ResultSet rs2 = stmt2.executeQuery("SELECT Sale.seller_id, sum(Sale.price) as b FROM Sale JOIN Item ON Sale.Sale_itemid = Item.itemid GROUP BY seller_id");
								while (rs2.next()) {
						   ...
						   <table class="table table-striped">
							...
							<%
								...
								ResultSet rs3 = stmt3.executeQuery("SELECT Sale.buyer_id, sum(Sale.price) as b FROM Sale JOIN Item ON Sale.Sale_itemid = Item.itemid GROUP BY buyer_id;");
								while (rs3.next()) {
